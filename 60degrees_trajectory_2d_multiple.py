...
def main():
    ...
    for r0 in r0:
        ...
        for x in check:
            if results_array[4,x] > (results_array[2,x]+0.00569504)/0.57735:
        ...
        coord = [[0,0],[0,.007],[-.003,.005],[-.003,.00035],[-.0034,.00035],[-.0034,.01],[-0.0144,.01],[-0.0144,.0026188],[-.0064,-.002],[-.0064,-.01],[-.0034,-.01],[-.0034,-.00035],[-.003,-.00035],[-.003,-.005],[0,-.007]]
